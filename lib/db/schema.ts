...
export const campuslinkUsers = pgTable('campuslink_users', {
  ...
  publicationsStatus: text('publications_status').default('not_applied').notNull(),
  publicationsMotivation: text('publications_motivation'),
  publicationsAppliedAt: timestamp('publications_applied_at'),
