    ...
    <div className="min-h-screen bg-off-white flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md border border-gray-200 bg-white p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="text-sm font-medium text-primary-text block mb-1">Full Name</label>
            <input
              type="text"
              required
          ...
          <div>
            <label className="text-sm font-medium text-primary-text block mb-1">Username</label>
            <input
              type="text"
              required
              className="w-full border border-gray-300 bg-white px-4 py-3 text-primary-text transition-colors focus:border-primary-green focus:outline-none focus:ring-2 focus:ring-primary-green/20"
          ...
          <div>
            <label className="text-sm font-medium text-primary-text block mb-1">Programme</label>
            <select
              className="w-full border border-gray-300 bg-white px-4 py-3 text-primary-text transition-colors focus:border-primary-green focus:outline-none focus:ring-2 focus:ring-primary-green/20"
          ...
          <div>
            <label className="text-sm font-medium text-primary-text block mb-1">Year of Study</label>
            <select
              className="w-full border border-gray-300 bg-white px-4 py-3 text-primary-text transition-colors focus:border-primary-green focus:outline-none focus:ring-2 focus:ring-primary-green/20"
              value={form.year}
